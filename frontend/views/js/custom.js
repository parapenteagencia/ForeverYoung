...
jQuery(document).ready(function($) {	
	...
	if( $map.length ) {
		$map.gMapResp({
			address: 'Paseo Tulum Mz 19A Lote 3 Local 104, Plaza Paseo Playacar, Playacar, 77717 Playa del Carmen, Q.R.',
			zoom: 16,
			controls: false,
			scrollwheel: false,
			styles: [ { "stylers": [ { "hue": "#F7C2A1" } ] } ],
			markers: [
				{ 'address' : 'Paseo Tulum Mz 19A Lote 3 Local 104, Plaza Paseo Playacar, Playacar, 77717 Playa del Carmen, Q.R.',
